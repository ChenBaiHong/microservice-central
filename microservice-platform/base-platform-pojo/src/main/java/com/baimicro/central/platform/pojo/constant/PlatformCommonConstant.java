package com.baimicro.central.platform.pojo.constant;

public interface PlatformCommonConstant {
    ...
    */
    ...
    /**阅读状态（0未读，1已读）*/
    public static final Integer HAS_READ_FLAG  = 1;
    public static final Integer NO_READ_FLAG  = 0;
    ...
    /**平台的ES日志路由名称*/
    public static final String REQUEST_PLATFORM_INFO = "request-platform-info";
}
