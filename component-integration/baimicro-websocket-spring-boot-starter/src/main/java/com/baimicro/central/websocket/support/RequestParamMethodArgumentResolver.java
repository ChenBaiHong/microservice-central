...
import com.baimicro.central.websocket.annotation.RequestParam;
...
import static com.baimicro.central.websocket.pojo.PojoEndpointServer.REQUEST_PARAM;

/**
 * @program: hospital-cloud-platform
 * @description: 若使用 @RequestParam 注解，请求参数解析类
 * @author: baiHoo.chen
 * @create: 2020-04-12
 **/
