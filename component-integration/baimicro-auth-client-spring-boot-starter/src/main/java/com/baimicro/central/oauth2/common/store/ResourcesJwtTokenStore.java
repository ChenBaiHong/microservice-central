...
/**
 * @className ResourcesJwtTokenStore
 * @Description TODO 资源服务器 TokenStore 配置类，使用 Jwt RSA 非对称加密
 * @Author baigle.chen
 * @Date 2019-11-10 16:05
 * @Version 1.0
 */
// 资源服务器配置类，使用 Jwt RSA 非对称加密
@ConditionalOnProperty(prefix = "his.cloud.oauth2.token.store", name = "type", havingValue = "resourcesJwt")
public class ResourcesJwtTokenStore {
