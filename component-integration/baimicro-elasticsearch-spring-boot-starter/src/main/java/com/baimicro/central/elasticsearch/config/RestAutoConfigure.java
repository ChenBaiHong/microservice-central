package com.baimicro.central.elasticsearch.config;

import com.baimicro.central.elasticsearch.properties.RestClientPoolProperties;
 ...
 * @description: elasticSearch 自动配置
 * @author: baiHoo.chen
 * @create: 2020-04-07
 **/
